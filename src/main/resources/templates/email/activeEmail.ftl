...
<pages xmlns="http://www.w3.org/1999/xhtml" class="ie"><![endif]--><!--[if !IE]><!-->
            ...
            <div role="banner">
                <div class="header"
                    ...
                    <div class="logo emb-logo-margin-box"
                         ...
                         align="center">
                        <div class="logo-right" style="font-size:26px !important;line-height:32px !important;"
                             align="right" id="emb-email-header">DCW
                        </div>
                    </div>
                        ...
                        <div class="column"
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                                    <p class="size-15"
                                       style="Margin-top: 0;Margin-bottom: 0;font-size: 15px;line-height: 23px;text-align: left;"
                                       lang="x-size-15">Hi,${username}</p>
                                    <p class="size-14"
                                       style="Margin-top: 20px;Margin-bottom: 0;font-size: 14px;line-height: 21px;text-align: left;"
                                       lang="x-size-14">您的邮箱已经修改！</p>
                                    <p class="size-14"
                                       style="Margin-top: 20px;Margin-bottom: 20px;font-size: 14px;line-height: 21px;text-align: left;"
                                       lang="x-size-14">请在24小时之内点击下面的“激活邮箱”按钮，完成修改过程。</p>
                                </div>
                            </div>
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div class="btn fullwidth btn--shadow btn--medium" style="text-align: center;">
                                    <![if !mso]><a
                                        ...
                                        href="http://localhost:8888/user/active?token=${token}">激活邮箱</a><![endif]>
                                    <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p>
                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                             href="http://localhost:8888/user/active?token=${token}"
                                             style="width:560px" arcsize="10%" fillcolor="#1293E3" stroke="f">
                                    <v:shadow on="t" color="#0E76B6" offset="0,2px"></v:shadow>
                                    <v:textbox style="mso-fit-shape-to-text:t" inset="0px,9px,0px,8px">
                            ...
                            <div class="column wide"
                                ...
                                <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                                    ...
                                    <div style="font-size: 12px;line-height: 19px;">
                                        <div>&#169; 2017 DCW&#174;. All rights reserved.</div>
                                    </div>
